...
def traceT_correlation():
	...
	# determine which method to use (singular)
...
if __name__=='__main__':
	"""
		This is specifically made for the traceT collection, and should be used when altering images
		made for my thesis. This should have little application in other fields of analysis
	"""
	# all functions	
