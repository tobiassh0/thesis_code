...
sim_loc = getSimulation('/home/space/phrmsf/Documents/EPOCH/5_devel/epoch1d/twoStream_new')
...
#	c+=1
	...
	plt.scatter(xProtons,vxProtons/vthE,color='g',s=1)
	plt.show()
	plt.clf()
