...
wnorm = getCyclotronFreq(d0,'Electrons')
vA = getAlfvenVel(d0)
knorm = wnorm/vA
...
fig.savefig('/storage/space2/phrmsf/ECRH/FT2d_Ex_PSD.png',bbox_inches='tight')
fig.savefig('/storage/space2/phrmsf/ECRH/FT2d_Ex_PSD.eps',bbox_inches='tight')
plt.show()
...
#
### spectrograms
#Spower = getSpectrogram(fieldmatrix,times,majspec='Protons',minspec='FElectrons',plot=True)
#dumpfiles(Spower,'Sx_mat_nfft_{}_noverlap_{}'.format(nfft,noverlap))
