...
def powerspectrum(trans,wnorm,wlim,klim,harmonicmin,harmonicmax,kmodelow,kmodehigh):
	# Plots Fourier power as a function of frequency.
	# trans - input matrix that has been 2D FT'd
	# wlim, klim - obtain from "getDispersion" limits
	# harmonicmin,harmonicmax,kmodelow,kmodehigh - normalised limits.
...
def power(klim_prime,wlim_prime,wmax,kmax,wnorm,norm_omega=r'$\Omega_D$',quantity='Magnetic_Field_Bz',plot=False,read=True,outp=True):
	if read:
		try:
