...
#		self.sim_file_loc = getSimulation('/storage/space2/phrmsf/lowres_D_He3/0_34_p_90')
		...
		## load 0th and last file for later use in calculation of constants
		try:
			print('Loading first and last file...')
			self.file0 = sdfread(0)
			self.filelast = sdfread(self.index_list[-1])
			print('Done.')
		except: # loads 1st if 0th is not present
...
if __name__ == '__main__':
	...
	simloc = '/storage/space2/phrmsf/lowres_D_He3/energy_protons/15MEV' #traceT/90deg' #lowres_D_He3/energy_protons/10MEV'
	Simulation(simloc)
